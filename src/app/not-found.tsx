    ...
    <section className="flex flex-col items-center justify-center gap-8">
      <div className="relative active:scale-[0.98] duration-300 h-[70vh] w-[60vw] rounded-xl flex items-center justify-center overflow-hidden">
        <div className="text-3xl font-bold absolute bottom-0 bg-gradient-to-b from-transparent via-black/70 to-black/90 w-full text-center py-24">
          ...
          <p className="translate-y-14 text-xl text-neutral-300 text-pretty font-normal">
      ...
      <div className="flex flex-row gap-4">
        <Link href="/">
          <button className="py-4 px-5 flex flex-row border rounded-md items-center justify-center font-semibold gap-2 active:bg-neutral-800/40 active:scale-95 hover:bg-neutral-800/70 duration-300">
            <FaHouseChimney/>
            <span>Go Home</span>
          </button>
        </Link>
